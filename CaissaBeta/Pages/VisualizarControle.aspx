<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/MasterPageProject.master" AutoEventWireup="true" CodeFile="VisualizarControle.aspx.cs" Inherits="Pages_VisualizarControle" %>
    ...
    <div class="row">
        <div class="col-lg-12">
            <ol class="breadcrumb top30">
                <li><a href="#">Home</a></li>
                <li><a href="#">Test</a></li>
                <li class="active">ViewAssessmentItems</li>
            </ol>
            <h3 class="page-header">Assessment Items - <asp:Literal ID="lTest" runat="server"></asp:Literal></h3>
            <div class="row">
                <div class="col-lg-12">
                    <div class="btn-group pull-right">
                        ...
                        <asp:LinkButton ID="btnUnbindItem" CssClass="btn btn-default" OnClick="btnUnbindItem_Click" runat="server">
                            <span class="fa fa-unlink fa-fw"></span> Unselect Item(s)
                        </asp:LinkButton>
                    </div>
                </div>
            </div>
                                            ...
                                            <ItemTemplate>
                                                <tr class="odd gradeA">
                                                    ...
                                                    <td class="text-center">
                                                        <asp:CheckBox ID="chkUnbindItem"
                                                            data-value='<%# Eval("tia_codigo") %>'
                                                            runat="server" />
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
